...
class PublicServiceController(
    ...
    ): ResponseEntity<PublicServiceDTO> = if (endpointPermissions.hasOrgReadPermission(jwt, catalogId)) {
    ...
    ): ResponseEntity<PublicServiceDTO> = if (endpointPermissions.hasOrgWritePermission(jwt, catalogId)) {
