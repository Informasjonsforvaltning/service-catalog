...
@Table(
    ...
    indexes = [
        Index(name = "idx_public_services_catalog_id", columnList = "catalog_id"),
        Index(name = "idx_public_services_catalog_id_published", columnList = "catalog_id, published")
    ]
)
...
data class PublicService (
    ...
    @Column(name = "dct_type", columnDefinition = "jsonb")
